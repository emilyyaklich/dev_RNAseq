...
os.chdir('/home/ely67071/dev_RNAseq/sunflower/go_analysis/wgcna/')

# read in the GO ontology
go_obo = '/home/ely67071/dev_RNAseq/sunflower/go_analysis/go-basic.obo'
...
go_module_data= pd.read_csv('/home/ely67071/dev_RNAseq/sunflower/wgcna/go_module_data.csv')
...
for go_id in unique_term_list:
    try:
        ...
        obsolete.append(go_id)  # Append go_id to the obsolete list
print("These are obsolete terms:")
print(obsolete)
...
for module in modules:
    ...
    goeaobj.wr_xlsx(module+'_module_enrichment_results_all.xlsx', goea_results_all)

# combine all of the spreadsheets into a single spreadsheet with different "sheets"
writer = ExcelWriter("module_significant_enrichment_results_all.xlsx")
with pd.ExcelWriter("module_significant_enrichment_results_all.xlsx") as writer:
    for filename in glob.glob("*_module_enrichment_results_all.xlsx"):
