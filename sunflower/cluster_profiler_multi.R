...
run_go_compareCluster <- function(direction = c("up", "down"),
  ...
  write_xlsx(result_list,file.path(output_dir,paste0("go_", direction, "_", ontology, ".xlsx")))
...
# plot the data
options(enrichplot.colours = c("plum","lightskyblue")) 
...
ggsave("sunflower/go_results/multi/plots/up_regulated_BP_enrichment.png", plot = plot, height = 15, width = 10, dpi = 300)
...
ggsave("sunflower/go_results/multi/plots/up_regulated_BP_enrichment_simp.png", plot = plot, height = 15, width = 10, dpi = 300)
...
go_down_bp_simp <- simplify_go_compareCluster(go_down_bp,direction = "down",ontology = "BP")
...
ggsave("sunflower/go_results/multi/plots/down_regulated_BP_enrichment.png", plot = plot, height = 15, width = 10, dpi = 300)


# plot the simplified/non-redundant terms
options(enrichplot.colours = c("firebrick2","darkgoldenrod2")) 
plot <- dotplot(go_down_bp_simp, showCategory = 15) +
  labs(title = "down-regulated enrichment (BP)", x = "dev. stage") +
  theme_minimal()

print(plot)

ggsave("sunflower/go_results/multi/plots/down_regulated_BP_enrichment_simp.png", plot = plot, height = 15, width = 10, dpi = 300)
...
go_up_mf_simp <- simplify_go_compareCluster(go_up_mf, direction = "up", ontology = "MF")
...
ggsave("sunflower/go_results/multi/plots/up_regulated_MF_enrichment.png", plot = plot, height = 15, width = 10, dpi = 300)

# plot the simplified/non-redundant terms
options(enrichplot.colours = c("hotpink", "seagreen")) 
plot <- dotplot(go_up_mf_simp, showCategory = 15) +
  labs(title = "up-regulated enrichment (MF)", x = "dev. stage") +
  theme_minimal()

print(plot)

ggsave("sunflower/go_results/multi/plots/up_regulated_MF_enrichment_simp.png", plot = plot, height = 15, width = 10, dpi = 300)


# down

go_down_mf <- run_go_compareCluster("down", "MF", dataSigup, dataSigdown, gene_universe, org.Hannuus.eg.db)
go_down_mf_simp <- simplify_go_compareCluster(go_down_mf, direction = "down", ontology = "MF")
...
ggsave("sunflower/go_results/multi/plots/down_regulated_MF_enrichment.png", plot = plot, height = 15, width = 10, dpi = 300)

# plot the simplified/non-redundant terms
options(enrichplot.colours = c("firebrick2", "darkgoldenrod2")) 
plot <- dotplot(go_down_mf_simp, showCategory = 15) +
  labs(title = "down-regulated enrichment (MF)", x = "dev. stage") +
  theme_minimal()

print(plot)

ggsave("sunflower/go_results/multi/plots/down_regulated_MF_enrichment_simp.png", plot = plot, height = 15, width = 10, dpi = 300)
...
go_up_cc_simp <- simplify_go_compareCluster(go_up_cc, direction = "up", ontology = "CC")
...
ggsave("sunflower/go_results/multi/plots/up_regulated_CC_enrichment.png", plot = plot, height = 15, width = 10, dpi = 300)

# plot the simplified/non-redundant terms
options(enrichplot.colours = c("hotpink", "seagreen")) 
plot <- dotplot(go_up_cc_simp, showCategory = 15) +
  labs(title = "up-regulated enrichment (CC)", x = "dev. stage") +
  theme_minimal()

print(plot)

ggsave("sunflower/go_results/multi/plots/up_regulated_CC_enrichment_simp.png", plot = plot, height = 15, width = 10, dpi = 300)


# down

go_down_cc <- run_go_compareCluster("down", "CC", dataSigup, dataSigdown, gene_universe, org.Hannuus.eg.db)
go_down_cc_simp <- simplify_go_compareCluster(go_down_cc, direction = "down", ontology = "CC")
...
ggsave("sunflower/go_results/multi/plots/down_regulated_CC_enrichment.png", plot = plot, height = 15, width = 10, dpi = 300)

# plot the simplified/non-redundant terms
options(enrichplot.colours = c("firebrick2", "darkgoldenrod2")) 
plot <- dotplot(go_down_cc_simp, showCategory = 15) +
  labs(title = "down-regulated enrichment (CC)", x = "dev. stage") +
  theme_minimal()

print(plot)

ggsave("sunflower/go_results/multi/plots/down_regulated_CC_enrichment_simp.png", plot = plot, height = 15, width = 10, dpi = 300)
